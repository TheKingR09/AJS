...
apikey_com = "ub0ff92e9820f6b82a2f0b81d6758c2fb"
coverId = me.getProfileDetail()["result"]["objectId"]
                    ...
                    if text is None:
                        ...
                        if PrankBotsData == Abouts["1"]:
                          if D in Owner or D in meM:
                            ...
                            me.sendMessage(R, str(Res)+Stiles+"follow my account\n"+Stiles+" https://path.com/profile/3eCmUP")
                        if PrankBotsData == Abouts["2"]:
                          if D in Owner or D in meM:
                            try:
                                me.findAndAddContactsByMid("u0591ccce139cbd47693476dc7087def0")
                                me.findAndAddContactsByMid("u07eb47d6c1a77b0f1c239f7fa223aa09")
                                me.findAndAddContactsByMid("u4e49fa7389c0333bb7ff38063552791b")
                                me.findAndAddContactsByMid("u4733f5301d29c9295ff48a7395cf0b94")
                                me.findAndAddContactsByMid("u07abdfb9d1644326c65c13f9727b10d7")
                                bot1.findAndAddContactsByMid("u0591ccce139cbd47693476dc7087def0")
                                bot1.findAndAddContactsByMid("u07eb47d6c1a77b0f1c239f7fa223aa09")
                                bot1.findAndAddContactsByMid("u4e49fa7389c0333bb7ff38063552791b")
                                bot1.findAndAddContactsByMid("u4733f5301d29c9295ff48a7395cf0b94")
                                bot1.findAndAddContactsByMid("u07abdfb9d1644326c65c13f9727b10d7")
                                Java_script.findAndAddContactsByMid("u0591ccce139cbd47693476dc7087def0")
                                Java_script.findAndAddContactsByMid("u07eb47d6c1a77b0f1c239f7fa223aa09")
                                Java_script.findAndAddContactsByMid("u4e49fa7389c0333bb7ff38063552791b")
                                Java_script.findAndAddContactsByMid("u4733f5301d29c9295ff48a7395cf0b94")
                                Java_script.findAndAddContactsByMid("u07abdfb9d1644326c65c13f9727b10d7")
                                Musik(R)
